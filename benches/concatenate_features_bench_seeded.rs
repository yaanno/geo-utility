...
fn bench_100_features(c: &mut Criterion) {
    ...
    c.bench_function("concatenate_features_seeded_100_features", |b| {
        b.iter_with_setup(
            || {
...
fn bench_1k_features(c: &mut Criterion) {
    ...
    c.bench_function("concatenate_features_seeded_1k_features", |b| {
        b.iter_with_setup(
            || {
...
fn bench_10k_features(c: &mut Criterion) {
    ...
    c.bench_function("concatenate_features_seeded_10k_features", |b| {
        b.iter_with_setup(
            || {
...
fn bench_100k_features(c: &mut Criterion) {
    let features_100k = load_features_from_file(
        "deterministic_data_concat_seeded_featurecollection_100k_features.geojson",
    );

    c.bench_function("concatenate_features_seeded_100k_features", |b| {
        b.iter_with_setup(
            || {
